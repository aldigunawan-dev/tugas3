...
const SearchScreen = ({navigation}) =>{
    return (
      <View style={{backgroundColor: 'white', minheight: 780, zIndex:0, alignContent: 'center', flexDirection: 'column'}}>
        <View style={{backgroundColor: '#86b257',height:'70%',width:'100%', zIndex:0, position: 'absolute'}}></View>
